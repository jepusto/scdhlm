...
r_const <- c({user_rconst_base}, {user_rconst_trt}, {user_rconst_base2}, {user_rconst_trt2}, {user_rconst_cor}, {user_rconst_var}, 1L) # specify whether using random effects, cor struct, var struct, and level-1 errors
