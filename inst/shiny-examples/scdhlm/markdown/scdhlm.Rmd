...
Pustejovsky, J. E., Chen, M., & Hamilton, B. (`r substr(Sys.Date(),1,4)`). scdhlm: A web-based calculator for between-case standardized mean differences (Version `r packageVersion("scdhlm")`) [Web application]. https://jepusto.shinyapps.io/scdhlm
