...
> Pustejovsky, J. E., Chen, M., & Hamilton, B. J. (2020). SingleCaseES: A calculator for single-case effect size indices (Version `r packageVersion("scdhlm")`) [R package]. https://CRAN.R-project.org/package=scdhlm
