...
> Pustejovsky, J. E., Chen, M., & Hamilton, B. J. (2020). scdhlm: Estimating hierarchical linear models for single-case designs (Version `r packageVersion("scdhlm")`) [R package]. https://CRAN.R-project.org/package=scdhlm

Please cite the web application as follows:

> Pustejovsky, J. E., Chen, M., & Hamilton, B. (2020). scdhlm: A web-based calculator for between-case standardized mean differences (Version `r packageVersion("scdhlm")`) [Web application]. https://jepusto.shinyapps.io/scdhlm
