...
```{r Laski-vcov-expected, eval=TRUE}
...
The symmetric confidence interval is [`r round(CI_g(Laski_ES_RML),3)`] and the asymmetric confidence interval is [`r round(CI_g(Laski_ES_RML, symmetric = FALSE),3)`].
