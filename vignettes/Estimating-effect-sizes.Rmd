...
quality_ES_RML <- g_mlm(mod = quality_RML, p_const = c(0,1), r_const = c(1,0,1))
...
Laski_ES_RML <- g_mlm(mod = Laski_RML, p_const = c(0,1), r_const = c(1,0,1))
...
Laski_ES_RML2 <- g_mlm(mod = Laski_RML2, p_const = c(0,1), r_const = c(1,0,0,0,1))
Laski_ES_RML2
```
...
Schutte_g1 <- g_mlm(mod = hlm1, p_const = c(0,0,1, B - A), r_const = c(1,0,1))
Schutte_g1
```
...
Schutte_g2 <- g_mlm(mod = hlm2, p_const = c(0,0,1, B - A), r_const = c(1,0,0,0,1))
Schutte_g2
```
...
Schutte_g3 <- g_mlm(mod = hlm3, p_const = c(0,0,1,B - A), r_const = c(1,0,0,0,0,0,0,1))
Schutte_g3
